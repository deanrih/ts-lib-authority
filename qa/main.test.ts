/** biome-ignore-all lint/suspicious/noEmptySource: test case */
//legacy test
...
// // const test: Map<string, unknown>;

// // const qwe = test.getOrInsert("asd", 2);
// // const asd = test.getOrInsertComputed("asd", (x) => {
// // 	return 2;
// // });
